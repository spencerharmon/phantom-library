...
- Added a direct Phantom Actions panel on Phantom item detail pages and intercept the item-page kebab for Phantom channel items, avoiding Jellyfin web's native `/Users/{userId}/Items/{channelItemId}` lookup that 404s before opening the command menu.
